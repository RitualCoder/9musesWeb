  ...
  return (
    <Box>
      <Grid container spacing={2} sx={{ px: {xs: 3, md: 10}, py: 5, overflowX: "hidden", mt: 5 }}>
        <Grid item xs={12} sm={6} md={3}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, px: 3, py: 2 }}>
            ...
            <Typography fontSize={16} color={"white"} fontWeight={100}>
              ...
              <span style={{ textDecoration: "underline" }}>+33 0 00 00 00 00</span>, par&nbsp;
              <span style={{ textDecoration: "underline" }}>Whatsapp</span>&nbsp; ou par email.
            </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Box sx={{ display: "flex", flexDirection: "column", gap: 2, px: 3, py: 2 }}>
            <Typography variant="h2" fontSize={20} fontWeight={900} color={"white"}>
              NEWSLETTER
            </Typography>
            ...
            <Typography color={"gray"} fontSize={12}>
              En saisissant votre adresse e-mail ci-dessus, vous acceptez de recevoir notre newsletter donnant accès à
              nos derniers événements, offres et initiatives. Plus de détails sont fournie dans notre{" "}
              <span style={{ textDecoration: "underline", fontWeight: 800 }}>politique de confidentialité</span>
            </Typography>
          </Box>
        </Grid>
      </Grid>
