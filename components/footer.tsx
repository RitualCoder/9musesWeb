      ...
      <Grid item xs={12} sm={6} md={3}>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 2, px: 3, py: 2 }}>
          ...
          <Typography color={"gray"} fontSize={12}>
            En saisissant votre adresse e-mail ci-dessus, vous acceptez de recevoir notre newsletter donnant accès à nos
            derniers événements, offres et initiatives. Plus de détails sont fournie dans notre{" "}
